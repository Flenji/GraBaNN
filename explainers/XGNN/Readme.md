# XGNN
The code in this repository contains the implementation of XGNN (https://github.com/divelab/DIG/tree/main/dig/xgraph/XGNN). The code was partly modified and additional classes have been added to work with pytorch geometric.
